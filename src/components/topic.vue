  ...
  <div class="topic">
    ...
    <div class="topic" v-for="(t, index) in topicData" :key="index">
      ...
      <div class="radio" v-if="t.topic_type == 0">
        <el-radio v-for="(item, index) in t.choice" :key="index" v-model="t.user_answer" :label="item">
          {{ item }}
        </el-radio>
        {{ t.user_answer }}
      </div>
      ...
      <div class="checkbox" v-if="t.topic_type == 1">
        <el-checkbox-group v-model="t.user_answer">
          <el-checkbox :label="item" v-for="(item, index) in t.choice" :key="index"></el-checkbox>
        </el-checkbox-group>
        {{ t.user_answer }}
      </div>
      <!-- 判断题 -->
      ...
      <div class="fillInBlank" v-if="t.topic_type == 3">
        <el-input v-for="(q, index) in t.question" :key="index" type="textarea" autosize placeholder="请回答"
      ...
      <div class="text" v-if="t.topic_type == 4">
        <el-input type="textarea" v-model="t.user_answer" :autosize="{ minRows: 3, maxRows: 10 }" placeholder="请回答">
        </el-input>
        {{ t.user_answer }}
      </div>
    </div>
